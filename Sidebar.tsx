  ...
  return (
    <aside className="hidden md:flex w-72 bg-[#121212] border-r border-zinc-800 flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-8">
        <div>
            <h2 className="text-xs font-semibold text-zinc-500 uppercase tracking-widest mb-4 px-2">Main</h2>
        ...
        <div>
            <div className="flex items-center justify-between mb-4 px-2">
                <h2 className="text-xs font-semibold text-zinc-500 uppercase tracking-widest">Your Instances</h2>
                <button 
                    onClick={onAddBot}
        ...
        <div className="flex items-center justify-between p-3 rounded-2xl bg-zinc-900/50 border border-zinc-800/50">
            <div className="flex items-center gap-2 overflow-hidden">
                ...
                <div className="truncate">
                    ...
                    <p className="text-[10px] text-zinc-500 truncate">{user.subscription} Plan</p>
                </div>
            </div>
            <button 
                onClick={onLogout}
